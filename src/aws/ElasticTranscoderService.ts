...
import { File, TranscodeService, AwsTranscoderConfig, AwsTranscoderTypeConfig } from '../Api';

class ElasticTranscoderService implements TranscodeService {
  private transcoder: AWS.ElasticTranscoder;

  constructor(private config: AwsTranscoderConfig) {
...
export { ElasticTranscoderService };
